...
<div class="main-content-container container-fluid px-4">
        ...
        <div class="col">
            <div class="card card-small mb-5">
                ...
                <div class="card-body p-4 pb-3">
                    ...
                    <!-- Tambahkan elemen tabel -->
                    <table id="table-penjadwalan" border="1" class="table mb-0 table-striped table-bordered">
                        <thead class="bg-light">
                            <tr>
                                <th>#</th>
                                <th>Status</th>
                            ...
                            <div class="card-body p-4 pb-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="keterangan_anggota"
                                        placeholder="Masukkan Keterangan Anggota" name="ketanggota" readonly>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="card-body p-4 pb-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nickname_jemaat"
                                        placeholder="Masukkan Nickname Jemaat" name="nickname" readonly>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="tempat_lahir"
                                        placeholder="Masukkan Tempat Lahir" name="tmplhr" readonly>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="golongan_darah"
                                        placeholder="Masukkan Golongan Darah" name="goldar" readonly>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="pendidikan"
                                        placeholder="Masukkan Pendidikan" name="pdidikan" readonly>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="card-body p-4 pb-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="kode_pos"
                                        placeholder="Masukkan Kode Pos" name="kodepos" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="kelurahan">Kelurahan</label>
                                    <input type="text" class="form-control" id="kelurahan"
                                        placeholder="Masukkan Kelurahan" name="lurah" readonly>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="telp"
                                        placeholder="Masukkan nomor Telepon" name="telp" readonly>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="tab-pane fade" id="section4" role="tabpanel" aria-labelledby="tab4">
                            <div class="card-body p-4 pb-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="pdt_anak"
                                        placeholder="Masukkan PDT Anak" name="pdtanak" readonly>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="pdt_sidi"
                                        placeholder="Masukkan PDT Sidi" name="pdtsidi" readonly>
                                </div>
                                <div class="form-group">
    ...
    <script>
        ...
        window.onload = function () {
            ...
            document.getElementById('endDate').value = formattedDateToday;
        ...
        const sendRequest = () => {
            ...
            fetch('<?= base_url('penjadwalan/JadwalFromApi'); ?>', {
                method: 'POST',
                headers: {
        ...
        // Dalam JavaScript, tambahkan ".delete-btn" pada selektor
